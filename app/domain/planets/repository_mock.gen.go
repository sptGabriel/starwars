...
func (mock *RepositoryMock) Create(contextMoqParam context.Context, planet Planet) error {
...
func (mock *RepositoryMock) Delete(contextMoqParam context.Context, iD ID) error {
...
func (mock *RepositoryMock) GetByID(contextMoqParam context.Context, iD ID) (Planet, error) {
...
func (mock *RepositoryMock) GetByName(ctx context.Context, name string) (Planet, error) {
...
// List calls ListFunc.
func (mock *RepositoryMock) List(contextMoqParam context.Context) ([]Planet, error) {
